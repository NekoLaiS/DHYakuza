...
screen music_room():
    ...
    if ost.game_soundtrack:
        ...
        hbox:
            ...
            imagebutton:
                idle At(ConditionSwitch("ost.organizeAZ", "gui/music_room/A-ZOn.png", 
                        "True", "gui/music_room/A-Z.png"), imagebutton_scale)
                hover At("gui/music_room/A-ZHover.png", imagebutton_scale)
                action [ToggleVariable("ost.organizeAZ", False, True), 
                        Function(ost.resort)]
            
            imagebutton:
                idle At(ConditionSwitch("ost.organizePriority", 
                "gui/music_room/priorityOn.png", "True", 
                "gui/music_room/priority.png"), imagebutton_scale)
                hover At("gui/music_room/priorityHover.png", imagebutton_scale)
            ...
            imagebutton:
                idle At("gui/music_room/refreshList.png", imagebutton_scale)
                hover At("gui/music_room/refreshHover.png", imagebutton_scale)
